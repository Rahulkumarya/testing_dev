                        ...
                        <div className="flex items-center text-black">
                            ...
                            {user ? (
                                <div className="relative group">
                                    ...
                                    {/* Dropdown menu shown on hover for desktop or click for mobile */}
                                    <div
                                        className="hidden group-hover:flex flex-col absolute right-0 mt-2 w-44 bg-white rounded-md shadow-lg border z-50 text-black
                 800px:flex md:flex lg:flex sm:flex dark:bg-gray-900 dark:text-white"
                                    >
                                        <Link
                                            href="/dashboard"
                                            className="px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-t-md"
                                        >
                                            Dashboard
                                        </Link>
                                        <Link
                                        ...
                                        <button
                                            onClick={() => signOut()} // MOD: uses NextAuth's signOut function
                                            className="text-left px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-b-md"
                                        >
                                            Logout
                                        </button>
                                    </div>
